...
import {lastBookableDate,today,time,price,hoursSummary,type SiteConfig} from "@/lib/booking";
...
<p className="fine">Horários de Brasília. Agenda aberta por {site?.bookingWindowDays??30} dias e com antecedência mínima de {site?.minAdvanceMinutes??30} minutos.</p></div>}
