...
import {Scissors,Clock,ArrowRight,ArrowLeft,Check,CalendarDays,ShieldCheck,ChevronRight,ChevronUp,ChevronDown,MapPin} from "lucide-react";
...
const WHATSAPP_URL="https://wa.me/5546999073974";
...
return <div className="site"><header className="header"><a href="/" className="brand"><img src="/logo.png" alt="Barbearia Sharp Razors"/><span>SHARP RAZORS<small>BARBEARIA</small></span></a><nav><a className="active" href="#agendamento">Agendamento</a><a href="#horarios">Horários</a><a className="nav-location" href="#localizacao">Localização</a><a href={WHATSAPP_URL} target="_blank" rel="noreferrer" aria-label="WhatsApp da barbearia"><WhatsApp size={19}/></a><a href="https://www.instagram.com/barbeariasharprazors/" target="_blank" rel="noreferrer" aria-label="Instagram da barbearia"><Instagram size={19}/></a></nav></header>
...
<section className="hours" id="horarios"><h3><Clock size={18}/> Horário de funcionamento</h3><dl><dt>Segunda a sexta</dt><dd>08:00 – 11:30<span>13:30 – 19:30</span></dd><dt>Sábado</dt><dd>08:00 – 11:30<span>13:30 – 17:00</span></dd><dt>Domingo</dt><dd className="closed">Fechado</dd></dl><a href="https://www.instagram.com/barbeariasharprazors/" target="_blank" rel="noreferrer"><Instagram size={17}/>@barbeariasharprazors <ArrowRight size={15}/></a><a href={WHATSAPP_URL} target="_blank" rel="noreferrer"><WhatsApp size={17}/>(46) 99907-3974 <ArrowRight size={15}/></a></section></aside></div>
<section className="location" id="localizacao"><div className="location-info"><p className="eyebrow">ONDE ESTAMOS</p><h2>VENHA NOS VISITAR<span>.</span></h2><p>Estamos te esperando na Barbearia Sharp Razors. Use o mapa para traçar sua rota.</p><a className="location-link" href={MAP_URL} target="_blank" rel="noreferrer"><MapPin size={17}/>Abrir no Google Maps <ArrowRight size={15}/></a><a className="location-link" href={WHATSAPP_URL} target="_blank" rel="noreferrer"><WhatsApp size={17}/>Falar no WhatsApp <ArrowRight size={15}/></a></div><div className="location-map"><iframe title="Mapa com a localização da Barbearia Sharp Razors" src={MAP_EMBED_URL} loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen/></div></section></main>
